...
function Header() {
  ...
  return (
            <>
                { scrolling === true ? 
                <motion.div animate={{ backgroundColor: "#fff" }} className="h-32 navbar transition bg-white flex items-center text-slate-400 fixed z-40">
                    ...
                    <div className="navbar-center hidden lg:flex 2xl:ps-[23rem]">
                    ...
                    <div className="navbar-end 2xl:pe-12">
                        <motion.Link animate={{ backgroundColor: "#fff" }} to="" className="btn rounded-full bg-black text-white border-0 w-44 font-bold hover:text-black">Daftar</motion.Link>
                    </div>
                ...
                <div className="h-32 navbar flex items-center text-white fixed z-40">
                    ...
                    <div className="navbar-end 2xl:pe-12">
                        <Link to="" className="btn rounded-full bg-black text-white border-0 w-44 font-bold hover:text-black">Daftar</Link>
                    </div>
                    <div className="md:navbar-end lg:hidden mt-3 md:me-12 lg:me-0">
                        <div className="dropdown dropdown-bottom dropdown-end">
                        <label tabIndex={0} className="btn btn-ghost lg:hidden">
