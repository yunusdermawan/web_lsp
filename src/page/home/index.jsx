...
function Home() {
  return (
    <div style={{backgroundImage: `url(${background})`, height: '100%', width: '100vw'}} className='container bg-no-repeat md:bg-cover lg:bg-contain xl:bg-cover overflow-hidden'>
        ...
        <main className='lg:px-24 min-h-screen'>
            ...
            <div className='md:h-[30rem] lg:h-[30.625rem] xl:h-[37.5rem] relative'>
                <div className='absolute grid gap-8 grid-cols-2 z-30 md:mt-4 lg:mt-6 md:py-4 lg:py-6 xl:py-10 lg:px-8 bg-[#F2F0F4] rounded-3xl'>
            ...
            <div className='lg:mt-0 xl:mt-4'>
                <div className='flex justify-center uppercase lg:text-[2rem] text-white'><h1>Skema LSP P1 digital kreatif solusi</h1></div>
                <div className='lg:mt-2 xl:mt-6 lg:py-2 xl:py-4 lg:px-6 bg-[#F2F0F4] w-full font-sans lg:text-xl lg:font-semibold text-gray-500'>
                    <div className='flex lg:mb-1 xl:mb-3'>
                        <span className='lg:w-16 lg:text-[0.8rem] xl:text-sm'>1</span>
                        <span className='lg:w-[28.125rem] xl:w-[43.75rem] lg:text-[0.8rem] xl:text-sm'>Ahli Fluida Pengeboran Migas dan Panas Bumi</span>
                    ...
                    <div className='flex lg:border-t-2 xl:border-t-[0.185rem] lg:mb-1 xl:mb-3'>
                        <span className='lg:w-16 lg:text-[0.8rem] xl:text-sm lg:mt-2 xl:mt-3'>2</span>
                        <span className='lg:w-[28.125rem] xl:w-[43.75rem] lg:text-[0.8rem] xl:text-sm lg:mt-2 xl:mt-3'>Ahli Keselamatan dan Kesehatan Kerja</span>
                    ...
                    <div className='flex lg:border-t-2 xl:border-t-[0.185rem] lg:mb-1 xl:mb-3'>
                        <span className='lg:w-16 lg:text-[0.8rem] xl:text-sm lg:mt-2 xl:mt-3'>3</span>
                        <span className='lg:w-[28.125rem] xl:w-[43.75rem] lg:text-[0.8rem] xl:text-sm lg:mt-2 xl:mt-3'>Analisis Kemananan Siber</span>
                        <div className='lg:mt-1 xl:mt-2' >
                    ...
                    <div className='flex lg:border-t-2 xl:border-t-[0.185rem] lg:mb-1 xl:mb-3'>
                        <span className='lg:w-16 lg:text-[0.8rem] xl:text-sm lg:mt-2 xl:mt-3'>4</span>
                        <span className='lg:w-[28.125rem] xl:w-[43.75rem] lg:text-[0.8rem] xl:text-sm lg:mt-2 xl:mt-3'>Asisten Produser Televisi</span>
                        <div className='lg:mt-1 xl:mt-2' >
                            <ul className='list-disc uppercase lg:text-[0.8rem] xl:text-sm'>
                    ...
                    <div className='flex lg:border-t-2 xl:border-t-[0.185rem] lg:mb-1 xl:mb-3'>
                        <span className='lg:w-16 lg:text-[0.8rem] xl:text-sm lg:mt-2 xl:mt-3'>5</span>
                        <span className='lg:w-[28.125rem] xl:w-[43.75rem] lg:text-[0.8rem] xl:text-sm lg:mt-2 xl:mt-3'>Desainer Grafis Madya</span>
                        <div className='lg:mt-1 xl:mt-2' >
                            <ul className='list-disc uppercase lg:text-[0.8rem] xl:text-sm'>
                                <li>Ilmu Komunikasi</li>
                            </ul>
            ...
            <div className='lg:mt-24 xl:mt-40'>
                <div className='relative lg:w-[80%] lg:mx-auto'>
                    ...
                    <div className='absolute lg:right-[-10rem] lg:top-8'>
                        <img className='lg:w-[9.375rem]' src={reg_section4} alt="" />
                    </div>
                </div>
                <div className='lg:mt-6'>
                    ...
                    <div className='flex justify-center items-center lg:mt-2'>
                        ...
                        <div className='lg:w-40 xl:w-60 self-start lg:me-2'>
                        ...
                        <div className='lg:w-40 xl:w-60 self-end lg:me-2'>
